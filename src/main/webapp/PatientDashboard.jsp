...
<div class="container">
		  ...
		  <div class="container-fluid">
		    <div class="collapse navbar-collapse" id="myNavbar">
		      <ul class="nav navbar-nav">
		        <li class="active"><a href="PatientDashboard.jsp">DASHBOARD</a></li>
		        <li><a href="PDoctors.jsp">DOCTORS</a></li>
	...
	<div class="container">
		<div class="row" style="background-color:white; margin-left:-15px; margin-right:15px;">
			...
			<hr>
			<a href="PDoctors.jsp"><button type="button" class="btn btn-primary btn-lg btn-block">All Doctors</button></a>
			
			<a href=""><button type="button" class="btn btn-primary btn-lg btn-block">Book Appointments</button></a>
			<a href=""><button type="button" class="btn btn-primary btn-lg btn-block">View Health Record</button></a>
			<a href=""><button type="button" class="btn btn-primary btn-lg btn-block">My Account</button></a>
			<a href=""><button type="button" class="btn btn-primary btn-lg btn-block">Change Password</button></a>
			<hr>
