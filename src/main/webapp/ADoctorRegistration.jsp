		      ...
		      <ul class="nav navbar-nav">
		        ...
		        <span class="caret"></span>ADD NEW</button>
		         <ul class="dropdown-menu">
			      <li class="active"><a href="ADoctorRegistration.jsp">ADD DOCTOR</a></li>
			      <li class="divider"></li>
			...
			<div class="row" style="height:1000px;  margin-right:15px; margin-left:-15px;">
				<div class="jumbotron" style="height:1000px;">
					<div class="col-lg-12">
						...
						<form  method="post" action="ADoctorProcess.jsp">
...
<script type="text/javascript">
	...
	if(status == "success"){
		swal("Congrats","Doctor Added Successfully","success")
	}
</script>
